...
def get_batch(neox_args, tokenizer, context_tokens: torch.Tensor):
    """
...
def stream_tokens(
    ...
    context_tokens, attention_mask, position_ids = get_batch(
        neox_args, tokenizer, context_tokens
    )
...
def generate_samples_from_prompt(
    ...
    generated_texts = []
    while True:
        # [MP] Generalize this to both sequential wrappers as well as pipemodules
