...
def build_train_valid_test_data_iterators(neox_args):
    ...
    if neox_args.repeat_first_n_iterations is not None and train_data_iterator is not None:
        import itertools
        print(neox_args.repeat_first_n_iterations)
        train_data_iterator = itertools.islice(train_data_iterator, neox_args.repeat_first_n_iterations)
        train_data_iterator = itertools.cycle(train_data_iterator)
