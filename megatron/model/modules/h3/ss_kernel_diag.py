...
from .vandermonde import log_vandermonde_fast


try:
    from .vandermonde import log_vandermonde, log_vandermonde_transpose

    has_pykeops = True
    log.info("Pykeops installation found.")
except ImportError:
    has_pykeops = False
    from .vandermonde import log_vandermonde_naive as log_vandermonde
