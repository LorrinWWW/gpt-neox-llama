...
class NeoXArgsModel(NeoXArgsTemplate):
    ...
    hf_config_name_or_path: str = None
    """
    ...
    norm: Literal["layernorm", "rmsnorm", "flash_rmsnorm", "scalenorm"] = "layernorm"
    """
    ...
    scalenorm_epsilon: float = 1.0e-6
    """
    Scalenorm epsilon
    """
    ...
    """
    For H3 models, length of the short convolution.
    """
    ...
    """
    Use external slow heads in Hyena mixer (H3-style)
    """
    ...
    num_heads: int = 8
    """
    Number of heads in Badger/MHHyena
    """
    num_heads_2: int = 8
    """
    Number of heads in second type of Hyena layer
    """

    hyena_filter_cls: str = "implicit"  # ["implicit", "modal"]
    ...
    activation: Literal[
        "gelu", "geglu", "relu", "softsign", "swish", "mish", "silu", "identity"
    ] = "gelu"
    """
...
class NeoXArgsOptimizer(NeoXArgsTemplate):
    ...
    """
    Type of optimizer to use. Choose from ['adam', 'onebitadam', 'cpu_adam', 'cpu_torch_adam', 'sm3', 'sophia', 'madgrad_wd', 'sgd', 'adagrad']
...
class NeoXArgsTraining(NeoXArgsTemplate):
    ...
    repeat_first_n_iterations: int = None
    """
    repeat_first_n_iterations of train iter
    """
